...
plot <- ggplot() + 
  ...
  geom_point(data = map_dat, aes(x = lon, y = lat, color = m_Tday_p2), size = 0.9) + 
  scale_color_gradient2(low = "blue", mid = "yellow", high = "red",limits = c(lower,upper)) +theme_void() + coord_fixed()
plot
```
...
plot3 <- ggplot() + 
  geom_map(data = world, map = world, aes(x = long, y = lat, map_id = region), fill = "white", color = "lightgrey", size = 0.1) + 
  geom_point(data = map_dat, aes(x = lon, y = lat, color = cum_solrad_p2), size = 0.9) + 
  scale_color_gradient2(low = "blue", mid = "yellow", high = "red",limits = c(lower,upper)) +theme_void() + coord_fixed()
plot3
```
...
plot4 <- ggplot() + 
  geom_map(data = world, map = world, aes(x = long, y = lat, map_id = region), fill = "white", color = "lightgrey", size = 0.1) + 
  geom_point(data = map_dat, aes(x = lon, y = lat, color = thresh_tmin_p1), size = 0.9) + 
  scale_color_gradient2(low = "blue", mid = "yellow", high = "red",limits = c(lower,upper)) +theme_void() + coord_fixed()
plot4
```
